...
const Main = ( { words ,setIsGameFinished, setCorrectCount ,setInserted , inserted , setIncorrectCount, setIsGameStarted, isGameStarted, isFocused, setIsFocused, isWordsFetched ,divRef } ) => {
    ...
    return(
        <div className="main-container" ref={divRef} tabIndex={0} onFocus={() => setIsFocused(true)} onBlur={() => setIsFocused(false)} >
            ...
            {!isFocused ? <FocusWindow /> : <Game /> /* pass props to Game */}
            ...
            {/* add if iswordfetched variable true make game playable else not  */}
