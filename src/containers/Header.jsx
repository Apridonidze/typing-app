...
const Header = ( {  handleGameLength, isGameStarted,isGameFinished,seconds,setSeconds,minutes,setMinutes,secondsOutput,setsecondsOutput,minutesOutput,setMinutesOutput,inTime,setInTime, btnRef, setTargetButton} ) => {
    return (
        <div className="header-container" >
            <h1>typing-app</h1>

            <div className="row">
                <Buttons handleGameLength={handleGameLength} btnRef={btnRef} setTargetButton={setTargetButton}/>
